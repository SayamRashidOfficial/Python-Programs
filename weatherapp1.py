...
def get_weather(city):
    ...
    # Parse the reponse JSON to gt weather information weather 
    weather = res.json()
    ...
    #get the icon URL adn return all the weather information
...
#Button widge --> to search for the weather information 
